...
public class MediaItem {
    ...
    @Column(name = "backdrop_image", length = 512)
    ...
    @Column(name = "creators_json", columnDefinition = "json")
    ...
    public MediaItem(UUID id, String externalId, MediaType mediaType, String title, Integer releaseYear,
    ...
    public static class Builder {
        ...
        public MediaItem build() {
            return new MediaItem(id, externalId, mediaType, title, releaseYear, coverImage, backdropImage, description, trailerUrl, creatorsJson, genresJson, platformsJson);
        }
    }
}
